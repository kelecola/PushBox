  ...
  <div>
    <div class="login__wrapper">
      <div class="username__wrapper">
        ...
        <el-input v-model="conname"
          style=" width: 200px"></el-input>
      </div>
      <div class="password__wrapper">
        <div class="password">密码</div>
        <el-input v-model="conpassword"
          style=" width: 200px"></el-input>
      </div>
    </div>
    <table>
      <tr v-for="(item,index) in userList"
        ...
        <div>{{item[0]}}</div>
        <div>{{item[1]}}</div>
        <el-input v-model="user[`name${index+1}`]"
          style=" width: 200px"></el-input>
        <el-input v-model="user[`password${index+1}`]"
          style=" width: 200px"></el-input>
...
export default {
  ...
  methods: {
    add(index) {
      const user = [
        this.user[`name${index + 1}`],
        this.user[`password${index + 1}`]
      ]
